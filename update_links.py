...
wa_link = 'https://wa.me/919024952636?text=Hi%2C%20I%20would%20like%20to%20enquire%20about%20your%20services.'
...
def update_file(filepath):
    ...
    # These usually have href="#section-cta" or href="index.html#section-cta"
    content = content.replace('href="#section-cta"', f'href="{wa_link}" target="_blank"')
    content = content.replace('href="index.html#section-cta"', f'href="{wa_link}" target="_blank"')
    
    # Also the CTA email button
    content = content.replace('href="mailto:hello@enersoulshealing.com"', f'href="{wa_link}" target="_blank"')
